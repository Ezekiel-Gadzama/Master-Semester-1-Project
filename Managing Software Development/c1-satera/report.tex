...
\begin{coursereporttitle}
  ...
  {Temporary name}
  {% Who did what (CASE-RULES, title slide/page). Replace each placeholder.
    \member{Lishchenko Ivan}{\textit{[contribution to be added]}}
    \member{Smirnov Fedor}{\textit{[contribution to be added]}}
    \member{Cherkashin Nikita}{\textit{[contribution to be added]}}
    \member{Faki Doosuur Doris}{\textit{[contribution to be added]}}
    \member{Gadzama Ezekiel John}{\textit{[contribution to be added]}}
  }
